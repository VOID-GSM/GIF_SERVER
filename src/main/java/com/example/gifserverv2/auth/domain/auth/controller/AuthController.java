package com.example.gifserverv2.auth.domain.auth.controller;

import com.example.gifserverv2.auth.domain.auth.dto.request.OAuthSignInRequest;
import com.example.gifserverv2.auth.domain.auth.dto.response.CurrentUserResponse;
import com.example.gifserverv2.auth.domain.auth.dto.response.OAuthSignInResponse;
import com.example.gifserverv2.auth.domain.auth.service.AuthService;
import com.example.gifserverv2.auth.domain.auth.service.DgOAuthFlowService;
import com.example.gifserverv2.auth.global.security.AuthenticatedUser;
